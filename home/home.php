    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="./../branches/strathmore.php" class="list-group-item">Strathmore Cafeteria</a>
          <a href="./../branches/kilimanjaro.php" class="list-group-item">Kilimanjaro Cafeteria</a>
          <a href="./../branches/pate.php" class="list-group-item">Pate Cafeteria</a>
        </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              <!-- image from website--> <img class="d-block img-fluid" src="https://test.1prof.by/upload/news_img/big_picture/900_900_keks.jpg" alt="First slide">
            </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="http://www.t-mag.it/wp-content/uploads/2018/10/muffins-1844458_1920-e1540305249640.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="./../menu.html">Breakfast and Brunch</a>
                </h4>
                <h5>$$</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="https://lapidus-london.webnode.com/_files/200000002-508cd51816/700/coffee-2306471_960_720.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="./../menu.html">Tea and Coffee</a>
                </h4>
                <h5>$$$</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="http://cintaihidup.com/wp-content/uploads/2017/05/nasi-216419_1920-700x467.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="http://cfile235.uf.daum.net/image/2517C1415937B07A32CE0D" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="./../menu.html">Salads</a>
                </h4>
                <h5>$</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="http://livelovelook.ru/images/july2016/177-2.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="./../menu.html">Ice creams and yorghuts</a>
                </h4>
                <h5>$</h5>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="./../menu.html"><img class="card-img-top" src="https://www.womanhit.ru/media/CACHE/images/articleimage2/2019/3/burger-1156564960720-1/4d77005533d217fa46f96a34d1721ef3.jpg" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="./../menu.html">Fast food</a>
                </h4>
                <h5>$$</h5>
